...
const Register: React.FC<{Register: Function}> = (props: any) => {
  // setup for input
  ...
  const [rePasswordAccess, setRePasswordAccess] = useState(false);
      ...
      <IonContent fullscreen>
        <div className="flex items-center justify-center h-full w-full">
          <div className="px-6 py-2 w-full md:w-1/2 h-[80%]">
            <h1 className="text-2xl font-semibold py-4">Register</h1>
            ...
            {/* Alert */}
            <div className="hidden" id="alert_error_register">
              <div className="flex items-center pb-2">
                <IonBadge color="danger">
                  <IonIcon icon={alertOutline}></IonIcon>
                </IonBadge>

                <p className="ml-2" id="regsiter_error_message">Message</p>
              </div>
            </div>
            ...
            <IonList className="rounded-lg">
              ...
              <IonItem>
                ...
                <IonInput 
                  ...
                  onIonChange={(event) => setRePassword(event.detail.value!)}
                  onIonBlur={() => {
                    // Get element
                    const element: HTMLElement = document.getElementById("input_re_password_alert")!;
                    ...
                    if(rePassword === "" || password !== rePassword) {
                      ...
                      // Set access to true
                      setRePasswordAccess(true);
                    }
                  }}></IonInput>

                {/* Alert */}
                <div id="input_re_password_alert" className="hidden">
                  <IonBadge color="danger">
                    <IonIcon icon={alertOutline}></IonIcon>
                  </IonBadge>
                </div>
            ...
            <div className="mt-4 flex justify-between items-center">
              <IonButton color="light" expand="block" className="w-1/2" onClick={() => {
                ...
                // Check is safety
                if(emailAccess && usernameAccess && passwordAccess && rePasswordAccess) {
                  // Get element
                  ...
                  // Register
                  props.Register(email_t, username_t, password_t);
                } else {
                  // Set message and show
                  alert.alertMessage.innerHTML = "Kamu harus mengisi formulirnya";
