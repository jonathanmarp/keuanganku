...
class DebtUsers extends Controller
{
    private $types = [
        "owe", "owed"
    ];
    ...
    public function create($key, $type, $size)
    {
        ...
        $response->description = "Hutang telah ditambah";
    ...
    public function delete($key, $id)
    {
        ...
        // Make response
        $response = new ResponseData();
        $response->description = "Hutang telah dihapus";
    ...
    public function update($key, $id, $size)
    {
        ...
        // Make response
        $response = new ResponseData();
        $response->description = "Hutang telah diperbaharui";
    ...
    public function paid($key, $id)
    {
        ...
        // Make response
        $response = new ResponseData();
        $response->description = "Hutang telah dibayar";
        ...
        // Check if can delete now
        if($can_update && !$temp["paid"])
        {
            // Delete
            $temp->update([
                "paid" => true,
                "has_paid" => round(microtime(true) * 1000)
            ]);
        }
